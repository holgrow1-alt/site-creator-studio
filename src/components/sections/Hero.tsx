...
export function Hero() {
  ...
  return (
    <section id="hero" ref={ref} className="relative min-h-[580px] md:min-h-[700px] w-full overflow-hidden grain">
      ...
      >
        {/* Logo stacked — CLEAN & SIMPLE */}
        <div className="flex flex-col items-center gap-3 z-10">
          {/* Logo — HIGH QUALITY 190KB */}
          <motion.div
        ...
        {/* Clean separator line — removes pixelated sparkles */}
        <div className="w-full h-px bg-gradient-to-r from-transparent via-primary/60 to-transparent mt-6 mb-4" />
