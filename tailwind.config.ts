  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%,100%": { boxShadow: "0 0 60px hsl(152 100% 50% / 0.4)" },
          "50%": { boxShadow: "0 0 120px hsl(152 100% 50% / 0.7)" }
        },
      },
      animation: {
        ...
        "fade-in": "fade-in 0.8s var(--ease-cinematic, ease-out) both",
        "fade-up": "fade-up 1s var(--ease-cinematic, ease-out) both",
